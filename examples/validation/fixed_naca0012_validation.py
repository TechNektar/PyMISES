"""
PyMISES - Fixed NACA 0012 Validation Example

This example demonstrates the use of the fixed PyMISES solver for validating
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="PyMISES Fixed NACA 0012 Validation")
